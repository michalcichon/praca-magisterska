...
Silnik kategoryzacyjny został zaimplementowany w języku C++, z użyciem środowiska Visual Studio w wersji 2010 Express, która jest podstawową wersją tego środowiska, bezpłatną do zastosowań niekomercyjnych.
