...
%TODO zastanowic sie czy nie jest to teza i czy nie trzeba napisac w celu pracy streszczenia.
\section*{Cel pracy}
\addcontentsline{toc}{section}{Cel pracy}
Celem niniejszej pracy jest stworzenie silnika kategoryzacyjnego. Proponowany system miałby za zadanie przypisać dostarczony do niego obraz do odpowiedniej kategorii. W założeniu kategorie powinny zostać zdefiniowane przed uruchomieniem silnika kategoryzacyjnego, a nie tworzone dynamicznie w trakcie jego działania. System nie ma na celu tworzenia nowych kategorii, ale możliwe najdokładniejsze przypisanie nowych obrazów do kategorii zrozumiałych przez człowieka.
...
%Podsumowanie: Wszystkie te implementacje mają... ale brakuje im...

%TODO istnieje jeszcze aplikacja na Androida, ktora sluzy do kategoryzacji zdjec. Mozna o niej wspomniec.

%http://www.androidtapp.com/impala/
%http://nexus7.wonderhowto.com/how-to/categorize-old-new-photos-automatically-by-topic-your-nexus-7-for-tidier-gallery-0152068/
%https://play.google.com/store/apps/details?id=eu.euvt.impalamobile
