...
\begin{dedication}
\textit{Chciałbym złożyć serdeczne podziękowania Panu Promotorowi dr.~Maciejowi Śniechowskiemu za wszelką pomoc okazaną mi podczas realizacji niniejszej pracy oraz moim rodzicom za wsparcie na każdym etapie mojej edukacji. Pragnę również podziękować mojej narzeczonej Ewelinie, bez której wsparcia praca ta nigdy nie zostałaby ukończona.}
\end{dedication}
...
\include{03_implementacja}
\include{04_interpretacja_wynikow}
\include{05_zakonczenie}
\include{06_zawartosc_plyty}
