...
set output 'result-surf-2-1500-500.svg'
...
plot "SURF_SVM_2classes_k_1500_500.txt" using 1:2 title 'k=1500' with linespoints, "SURF_SVM_2classes_k_1500_500.txt" using 1:3 title 'k=500' with linespoints
