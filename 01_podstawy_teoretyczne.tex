...
Cecha GIST (\emph{ang. sedno}) w założeniu jest niskopoziomową reprezentacją sceny, która nie wymaga żadnej formy segmentacji. Podejście to nie jest alternatywą dla lokalnych cech obrazu ale może stanowić dodatkową pomoc przy rozpoznawaniu obiektów na nieuporządkowanej scenie.\cite{OLIVA06}
