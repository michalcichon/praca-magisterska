...
Cecha GIST (\emph{ang. streszczenie}) jest globalną cechą obrazu, która charakteryzuje całą scenę obrazu. Ekstrakcja cech GIST jest na ogół bardzo szybka, gdyż nie wymaga przeprowadzania kosztownych operacji grupowania lub klastrowania. Podejście to nie jest alternatywą dla lokalnych cech obrazu ale może stanowić dodatkową pomoc przy rozpoznawaniu obiektów na nieuporządkowanej scenie.\cite{OLIVA06}
...
Wyznaczenie cech dla pojedynczego obrazu jest bardzo szybkie i wynosi poniżej 1ms.
