...
Kanał orientacji tworzony jest za pomocą filtrów Gabbora na obrazie w skali szarości, w czterech różnych kątach $\theta_i = 0, 45, 90, 135^\circ$ oraz dla czterech różnych skalach przestrzennych $c = 0, 1, 2, 3$. Mapy cech dla orientacji $M_i(c)$ określamy jako:
\begin{equation} 
