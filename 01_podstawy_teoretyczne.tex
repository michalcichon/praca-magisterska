...
\begin{algorithm}{AdaBoost}{
	\label{algo:adaboost}
	\qinput Zbiór danych $\mathcal{D} = \{(\boldsymbol{x}_1, y_1), (\boldsymbol{x}_2, y_2), \cdots, (\boldsymbol{x}_m, y_m)\} $, podstawowy algorytm uczący $\mathcal{L}$, liczba rund uczących $T$ }
	$D_1(i)$ \qlet $1/m$ \\	
\end{algorithm}
