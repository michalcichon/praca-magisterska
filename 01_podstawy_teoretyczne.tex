...
Uczeń otrzymuje od nauczyciela informację o tym jakiego komunikatu wyjściowego oczekuje w odpowiedzi na przykładowe informacje wejściowe. Mogą być one dostarczone np. w formie wektorów składających się z danych oraz poprawnej odpowiedzi. Na podstawie przykładów, system ma wyuczyć się reagowania na dane w odpowiedni, pożądany sposób. Odpowiedź systemu należy do pewnego znanego zbioru klas.
