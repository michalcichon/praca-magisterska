...
Następnym krokiem jest tworzenie histogramów gradientów dla komórek. Dla każdej komórki wyznacza się lokalny jednowymiarowy histogram gradientu -- orientację krawędzi w stosunku do wszystkich pikseli w komórce. Każdy gradient orientacji dzieli zakres kątów na z góry określony zestaw koszyków.
