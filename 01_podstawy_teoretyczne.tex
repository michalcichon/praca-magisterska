...
Cecha GIST (\emph{ang. streszczenie}) jest globalną cechą obrazu, która charakteryzuje całą scenę. Ekstrakcja cech GIST jest na ogół bardzo szybka, gdyż nie wymaga przeprowadzania kosztownych operacji grupowania lub klastrowania. Podejście to nie jest alternatywą dla lokalnych cech obrazu ale może stanowić dodatkową pomoc przy rozpoznawaniu obiektów na nieuporządkowanej scenie.\cite{OLIVA06}

Sensowność tego podejścia jest poparta badaniami ludzkiej percepcji, które wykazały, że człowiek jest w stanie rozpoznać znaczenie nawet bardzo skomplikowanej sceny w krótkim czasie, nawet wówczas gdy obraz ten jest nieostry.\cite{SCHYNS94}
