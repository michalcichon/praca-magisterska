...
Adaptive Boosting (w skrócie AdaBoost) jest meta-algorytmem zaproponowanym przez Yoava Freunda i Roberta Schapire, który pozwala z kilku słabych klasyfikatorów otrzymać jeden lepszy.
