...
Klasyfikator k-najbliższych sąsiadów należy do leniwych metod uczących. W procesie uczenia nie jest budowany ogólny model klasyfikacyjny, natomiast do klasyfikacji nowego obiektu, o wejściowym wektorze $y$, analizowane są $k$ najbliższe obiekty, a następnie $y$ jest przydzielany do klasy, w której jest większość spośród $k$ obiektów.
